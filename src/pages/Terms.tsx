  ...
  return (
    <div className="legal-page">
      ...
      <main className="legal-content">
        <span className="eyebrow cyan-text">LEGAL</span>
        ...
        <section>
          ...
          <ul>
            ...
            <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to DataWeavex PVT LTD, No, 02 Union Place, Colombo 00200.</li>
            ...
            <li><strong>Website</strong> refers to dataweavex, accessible from <a href="https://dataweavex.net/" rel="external nofollow noopener" target="_blank">https://dataweavex.net/</a></li>
        ...
        <section>
          ...
          <ul>
            <li>By email: <a href="mailto:contact@dataweavex.net">contact@dataweavex.net</a></li>
            <li>By visiting this page on our website: <a href="https://dataweavex.net/" rel="external nofollow noopener" target="_blank">https://dataweavex.net/</a></li>
            <li>By phone (SL): +94718373531</li>
            <li>By phone (USA): +14844458251</li>
            <li>By mail (SL Address): No, 02 Union Place, Colombo 00200</li>
            <li>By mail (USA Address): 24 Waverly Pl, New York, NY 10003, USA</li>
          </ul>
        </section>
      </main>
    </div>
